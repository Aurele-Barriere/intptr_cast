...
** TODO [INTPTR][meminj] change unchanged_on
   ...
   But anyway, this will be used for loc_unmapped, whoch does not depend on the offset.
...
**** TODO [INTPTR][meminj][proofs] ValueDomain.v
     ...
     Neither worked. I don't know what to do.
**** DONE [INTPTR][meminj][proofs] Unusedglobproof.v
