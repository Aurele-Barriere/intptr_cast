...
*** TODO [INTPTR][mixedsim][simulations] prove the Deadcodeproof mixed simulation
    for the RTL->RTL proof in backend/Deadcodeproof.v
**** TODO [INTPTR][mixedsim][simulations][proof] init states backward
**** TODO [INTPTR][mixedsim][simulations][proof] final states
...
**** TODO [INTPTR][mixedsim][simulations][proof] external calls
     we need to take a look at the extcall_properties first
...
**** TODO [INTPTR][mixedsim][simulations][proof] determinate_at
...
**** TODO [INTPTR][mixedsim][simulations][proof] safety in backward simulation
*** TODO [INTPTR][mixedsim][simulations][determ] Determinacy of languages
**** TODO [INTPTR][mixedsim][simulations][determ] prove determinacy of Clight
...
**** TODO [INTPTR][mixedsim][simulations][determ] prove determinacy of Csharpminor
     we will need a lot of determ theorems
**** TODO [INTPTR][mixedsim][simulations][determ] prove determinacy of Cminor
**** TODO [INTPTR][mixedsim][simulations][determ] prove determinacy of CminorSel
**** DONE [INTPTR][mixedsim][simulations][determ] prove determinacy of RLT
**** DONE [INTPTR][mixedsim][simulations][determ] prove determinacy of LTL
**** TODO [INTPTR][mixedsim][simulations][determ] prove determinacy of Mach
     determinacy of rao and store_stack
     rao is just any function, with only one other hypothesis.
     Can we simply add the determinism of return_address_offset as an hypothesis?
     
     Store_stack is a call to Mem.storev, which should be deterministic.
...
** TODO Evaluation?
   ...
   Add a little time comparison to show that the compilation isn't slower and I think it should be anough.
