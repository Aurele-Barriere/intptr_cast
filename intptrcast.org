...
** TODO [INTPTR][mixedsim] every intermediate language is well_behaved_traces
   It should be true because it is for Cstrategy
** TODO [INTPTR][mixedsim] every intermediate language is single_events
   after CStrategy
...
** TODO [INTPTR][mixedsim] fix the proof of transf_cstrategy_program_preservation
