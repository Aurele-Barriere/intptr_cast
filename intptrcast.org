...
** TODO [INTPTR][mixedsim] prove each mixed simulation
   ...
   Started the proof of backend/Linearizeproof.v. Still need the determinacy, the initial states backward, 
   the strong receptivity, and the nostep on final states.
