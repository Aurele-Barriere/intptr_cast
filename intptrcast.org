...
** TODO [INTPTR][meminj] freed or non-declared distinction
...
*** TODO [INTPTR][meminj][free] Add offset_bounds preservation to unchanged_on
    I'm not sure.
*** TODO [INTPTR][meminj][free] Add memory consistency
...
*** TODO [INTPTR][meminj][free] Replace the definition of minjection
...
* TODO [INTPTR] add normalization of pointer (cast2int) and denormalization (cast2ptr)
