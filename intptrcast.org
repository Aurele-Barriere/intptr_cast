...
*** TODO [INTPTR][mixedsim][simulations] RTLgenproog | CminorSel -> RTL
...
*** TODO [INTPTR][mixedsim][simulations] Cleanuplabelsproof | Linear -> Linear
...
** TODO Figures and details to add
*** TODO optimization examples
*** TODO back_sim, fwd_sim, mixed_sim figures
*** TODO receptive and determinate definitions
*** TODO atomic semantics figure
*** TODO old and new correctness proofs
* TODO [INTPTR][pres] Presentation
  DEADLINE: <2017-08-04 Fri>
** TODO [INTPTR][pres] Presentation at show&tell
   SCHEDULED: <2017-08-04 Fri>
** TODO [INTPTR][pres] Write show&tell summary
...
* TODO [INTPTR] Things to do before the end
** DONE [INTPTR][plans] Pull request: mixed_simulation
** TODO [INTPTR][plans] Finish CSEproof with backward steps
   DEADLINE: <2017-07-17 Mon>
*** DONE [INTPTR][plans][mixed] senv equiv commutativity
*** TODO [INTPTR][plans][mixed] construct the external call with safety from the source
*** TODO [INTPTR][plans][mixed] eval_builtin_args_lessdef has to be changed for backward step
    the backward version does not seem to be true.
*** TODO [INTPTR][plans][mixed] exists valu: check the old proof
    use the analysis_correct_1 theorem.
** TODO [INTPTR][plans] Pull request: CSEproof_mixed
   DEADLINE: <2017-07-17 Mon>
** TODO [INTPTR][plans] Finish Constpropproof
   DEADLINE: <2017-07-19 Wed>
   Inop states should be stuttering, we should not need determinacy
** TODO [INTPTR][plans] Pull request: Constpropproof_mixed
   DEADLINE: <2017-07-19 Wed>
** TODO [INTPTR][plans] Evaluation
   DEADLINE: <2017-07-20 Thu>
...
** TODO [INTPTR][plans] Finish report and presentation
