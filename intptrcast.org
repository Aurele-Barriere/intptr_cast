...
** DONE [INTPTR][memupdate] change memory extension
...
** DONE [INTPTR][memupdate] change unchanged_on
   
   We need to add mem_concrete preservation, for the proof in Separation.v, I think
   
** TODO [INTPTR][memupdate][injection] change memory injection
...
*** DONE [INTPTR][memupdate][injection] No source concrete and target logical in public
...
*** DONE [INTPTR][memupdate][injection][proofs] prove the new injection
**** DONE [INTPTR][memupdate][injection][proofs] Memory.v
     the two last proofs require a better version of extends
     extends must preserve the field mem_concrete, I think.
**** DONE [INTPTR][memupdate][injection][proofs] Separation.v
     We just need to change the unchanged_on definition to add that mem_concrete is preserved.
     Then the proof will be ok.
**** DONE [INTPTR][memupdate][injection][proofs] ValueDomain.v
**** DONE [INTPTR][memupdate][injection][proofs] Unusedglobproof.v
     I don't know how to do that.
*** TODO [INTPTR][memupdate][injection] No source concrete in private

    where is private memory?

*** DONE [INTPTR][memupdate][injection] Concrete addresses equality?
...
** TODO [INTPTR][memupdate] Definition of max_address
