...
*** TODO [INTPTR][mixedsim][simulations] Apply the mixed simulation
...
**** DONE [INTPTR][mixedsim][simulations][proof] stongly_receptive_at
**** TODO [INTPTR][mixedsim][simulations][proof] determinate_at
     I just need to finish the proof of match_not_external
**** TODO [INTPTR][mixedsim][simulations][proof] sound_state
...
** TODO [INTPTR][mixedsim] prove the new external_call properties
   ...
   there's an issue with ec_mem_inject and volatile_load
