...
** DONE [INTPTR][memupdate] pull request
** TODO [INTPTR][memupdate] put consistency inside of mem'
** TODO [INTPTR][memupdate] memory size?
** TODO [INTPTR][memupdate] no let
** TODO [INTPTR][memupdate] inductive addr_in_concrete_block. inductive consistency
** TODO [INTPTR][memupdate] name hypothesis in weaker_access
** TODO [INTPTR][memupdate] remove comment in empty
** TODO [INTPTR][memupdate] change exists_at_most_one_block
