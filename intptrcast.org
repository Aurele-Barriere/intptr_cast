...
** TODO [INTPTR][plans] Finish DeadCodeproof with backward steps
   DEADLINE: <2017-07-17 Mon>
** TODO [INTPTR][plans] Pull request: DeadCodeproof_mixed
   DEADLINE: <2017-07-17 Mon>
...
** TODO [INTPTR][plans] Evaluation
   ...
   Try to see when are optimization done, wand when they aren't,
