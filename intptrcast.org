...
**** DONE [INTPTR][meminj][proofs] Unusedglobproof.v
** TODO [INTPTR][meminj] pull request
*** TODO [INTPTR][meminj][PR] remove perm_range?
...
** TODO [INTPTR][mixedsim] understand the proof of mixed sim -> backwards sim
** TODO [INTPTR][mixedsim] understand the strongly receptive notion
